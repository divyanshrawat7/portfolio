        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building scalable machine learning models, predictive pipelines, and data-driven solutions using modern AI frameworks.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Developing robust full-stack applications with responsive front-ends and efficient back-end services.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
